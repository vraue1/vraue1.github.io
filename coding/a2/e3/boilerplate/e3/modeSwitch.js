...
if(window.matchMedia("(prefers-color-scheme: dark)").matches){
  ...
  document.documentElement.style.setProperty("--col-03", lightCol2);
  document.documentElement.style.setProperty("--col-04", darkCol2);
...
function switchModes(){
  ...
  if (isDark){
    ...
    document.documentElement.style.setProperty("--col-03", darkCol2);
    document.documentElement.style.setProperty("--col-04", lightCol2);
